            ...
            <div class="container">
               <!--  <a class="navbar-brand" href="index.html">
				...
				<security:authorize access = "isAuthenticated()">
                    ...
                    <form class="d-flex header__form-search" action="search" method="GET">
                        <input class="form-control search-story" type="text" placeholder="Tìm kiếm" name="name"
                            value="">
            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-end text-bg-dark w-75" tabindex="-1" id="offcanvasDarkNavbar"
                    ...
                    <div class="offcanvas-body">
                        ...
                        <form class="d-flex header__form-search" method="GET">
