				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" acceptCharset="UTF-8" action="update" method="PUT" modelAttribute="model" enctype="multipart/form-data">
						...
						<div class="form-group">
							  ...
							  <div class="col-sm-9">
							  	 <form:select path="categoryCode" id="categoryCode" name="categoryCode">
						...
						<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="title" cssClass="col-xs-10 col-sm-5" id="title" name="title"/>
								</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						  	...
						  	<div class="col-sm-9">
		                   		<form:textarea path="shortDescription" rows="5" cols="10" cssClass="form-control summernote" id="content"/>
						  	</div>
						</div>
						
						
						<div class="form-group">
						  	<label for="content" class="col-sm-3 control-label no-padding-right">Tác giả:</label>
						  	<div class="col-sm-9">
						  		<form:textarea path="author" rows="5" cols="10" cssClass="form-control" id="author"/>
						  	</div>
						</div>
						<div class="form-group">
							  ...
							  <div class="col-sm-9">
							  	 <form:select path="status" id="status" name="status">
							  	 	<form:option value="0" label="Còn"/>
							  	 	<form:option value="1" label="Full"/>
							  	 </form:select>
							  </div>
						</div>
